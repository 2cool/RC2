...
//	static public String message="message";
	...
	static final int MIN_VOLT =320;
	static final int VOLT_50  =380;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	static public void bufferReader_(byte buf[],int buf_len){
		...
		min_volt=(b0<b1)?((b0<b2)?b0:b2):((b1<b2)?b1:b2);
		F_MIN_VOLT=min_volt<=MIN_VOLT;
		batery=Integer.toString(b0)+","+Integer.toString(b1)+","+Integer.toString(b2)+",";
		gimbalPitch= buf[i++];
